...
module CSA
  class Config
    ...
    attr_reader :api_key_id, :api_issuer_id, :api_key_file, :selected_filters
    ...
    def initialize(options)
      ...
      @api_key_file = resolve_api_key_file(options[:api_key_file], @api_key_id)
    ...
    def resolve_api_key_file(provided_key_file, key_id)
      return provided_key_file if provided_key_file
